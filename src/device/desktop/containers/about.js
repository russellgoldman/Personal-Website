    ...
    return (
      <div>
        <div style={styles.outerContainer}>
          <div style={styles.innerContainer}>
            ...
            <div style={styles.bioContainer}>
              <div style={styles.textContainer} className="animated fadeIn">
                <p style={{ fontSize: '16px' }}>Russell Goldman is a Computer Science undergrad going into his 3rd year at Laurier.
          ...
          {/* move resume button to the contact section of the site */}
